...
long double pif_long_double = M_PI;
...
cout << "Valor de pi com long double de casas decimais: " << setprecision(LDBL_MAX) << pif_long_double << endl; // Pi com várias casas decimais
